...
- **创建项目权限**：控制哪些成员可以创建项目，可多选「所有人」「部门负责人」「指定人员」。
  - **所有人**：所有成员均可创建项目。
  - **部门负责人**：部门负责人与部门管理员可创建项目。
  - **指定人员**：仅下方手动指定的人员可创建项目（最多 200 人）。
  - 系统管理员始终可创建项目，不受此开关限制；未授权的成员将自动隐藏「新建项目」入口。
- **部门负责人视角**：开启后，部门负责人 / 部门管理员可**只读**查看本部门及下级部门成员参与的项目和项目内全部任务，便于掌握团队进展（具体展示范围仍受任务可见性设置约束）。
...
- **AI 自动分析**：开启时，AI 助手会对任务进行自动分析并给出建议；可按需关闭，避免不必要的分析消耗。
...
- **匿名消息**：开启时，用户可以匿名发送消息。
- **待办设置权限**：控制谁可以为他人设置或取消[聊天待办](/functions/im/todo)。
  - **允许**：所有成员均可设置 / 取消他人的待办。
