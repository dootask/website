...
**功能概述**
- **创建员工账号**: 管理员可直接为成员创建账号，并填写部门、职位等信息，无需成员自行注册即可加入团队。
- **批量导入员工**: 支持一次性批量导入多个员工账号，并同步填写部门、职位等信息，快速完成团队组建或大规模人员录入。

**使用建议**
- 批量导入前，先整理好部门与职位信息，确保导入后组织结构清晰、信息完整。
- 为新成员设置初始密码后，建议提醒其首次登录后及时修改。
...
- **标记邮箱认证状态**: 管理员可手动标记成员的邮箱认证状态，使成员信息更易管理，也便于配合上方的邮箱认证状态筛选。
- **查看项目与任务**: 在会员卡片中可通过「项目与任务」入口，直接查看该成员参与的项目、待办与已完成任务，团队协作进展一目了然。
