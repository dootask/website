...
AI 助手的聊天记录现在会**自动保存**，换设备登录或重新打开后，也能继续查看此前的历史对话，无需担心上下文丢失，对话体验更连贯。

- **跨设备同步**：在电脑、移动端等不同设备上都能查看同一份历史对话。
- **延续上下文**：重新打开 AI 助手即可接着之前的话题继续交流。
- **图片更清晰**：对话中的长图显示经过优化，减少压缩后变模糊的问题。

> 你也可以在系统设置中通过「[AI 自动分析](/functions/account/system-setting)」开关，按需控制 AI 助手对任务的自动分析。
